...
Pod::Spec.new do |s|
  s.name             = 'Computop'
  s.version          = '0.1.0'
  s.summary          = 'A short description of Computop.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/Computop'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Thomas Segkoulis' => 'thomas.segkoulis@exozet.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/Computop.git', :tag => s.version.to_s }
